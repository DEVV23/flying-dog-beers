...
app.layout = html.Div([
    ...
    labelStyle={'display': 'inline-block'}
        ...
        html.Div([
            html.A(
                    html.Button(children=html.B('Download Results',style={'color':'white'}),style={"background-color":"#234B88"}),
                                id='download-link-sent',href=" ",download="Final_Output.csv",target="_blank"),
